        ...
        <div id="main-container">
           <?php foreach ($prodotti as $prodotti): ?>
               <div class="container-vendita">
                    <a href="dettagli_prodotto.php?id=<?php echo $prodotti['id']; ?>">
                    <img src="<?php echo htmlspecialchars($prodotti['image']); ?>" alt="<?php echo htmlspecialchars($prodotti['prodotto']); ?>">
                    </a>
                  <div >
                    <a href="ettagli_prodotto?id=<?php echo $prodotti['id']; ?>"><?php echo htmlspecialchars($prodotti['prodotto']); ?></a>
                  </div>
                <p> 
                  <strong><span><?php echo number_format($prodotti['prezzo'], 2); ?> €</span></strong>
                </p>                                      
          </div>
           <?php endforeach; ?>  
          </div>
